...
//const std::array<double, nptBins + 1> ptbinsvec = {15, 20};
...
//const std::array<double, nyBins_both + 1> ybinsvec = {1.5, 2.4};
...
//const std::array<double, nmBins_both + 1> nmbinsvec = {0,20};

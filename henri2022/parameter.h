...
const std::array<double, nmBins_both + 1> nmbinsvec = { 0,20,30,40,50,60,70,100};
	...
	double  FRfr2018_Y_SystUpRatio[4]  ={0.460*0.5148, 0.193*0.2795, 0.090*0.3938, 0.139*0.2949};
	double  FRfr2018_Y_SystDownRatio[4]={0.461*0.5148, 0.193*0.2795, 0.091*0.3938, 0.139*0.2949};
    //2018 PbPb fsfu
	//TO BE USED IN Bmeson_Ratio.C 
